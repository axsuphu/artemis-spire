...
const Hero = ({ getImagePath }) => {
  ...
  return (
    <>
      ...
      >
        <div className="mx-10 my-8 flex flex-col gap-48 font-bakbak text-white 2xl:left-52 2xl:mx-0 2xl:my-32 2xl:w-4/5 2xl:tracking-widest">
          ...
          <div className="flex justify-end 2xl:justify-start">
            <div className="flex w-5/6 items-end">
              <h2 className="lg:w-11/22 text-md mb-2 text-right leading-none sm:text-lg md:mb-6 md:w-4/5 md:text-2xl lg:w-2/3 lg:text-left xl:w-2/3 xl:pr-4 xl:text-2xl 2xl:w-2/3 2xl:text-4xl">
