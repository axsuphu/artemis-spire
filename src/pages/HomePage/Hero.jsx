...
const Hero = ({ getImagePath }) => {
  ...
  return (
    <>
      ...
      >
        <div className="2xl:gap-34 mx-10 my-6 flex flex-col gap-8 font-bakbak text-white sm:mx-0 sm:my-8 sm:w-2/3 md:mx-0 md:mb-8 md:mt-14 md:w-11/12 md:gap-14 lg:absolute lg:left-32 lg:m-0 lg:w-2/3 lg:gap-24 lg:pl-4 xl:top-24 xl:w-7/12 xl:gap-28 xl:p-0 2xl:left-52 2xl:top-36">
          ...
          <div className="sm:flex sm:flex-col md:items-end lg:items-start">
            <h2 className="lg:w-11/22 mb-2 text-right text-xl sm:text-lg md:mb-6 md:w-4/5 md:text-2xl lg:w-2/3 lg:text-left xl:w-2/3 xl:pr-4 xl:text-2xl 2xl:w-3/5 2xl:pb-6 2xl:text-3xl">
              ...
              technology, all from the leading innovator in gaming experiences.
            </h2>
          </div>
        </div>
